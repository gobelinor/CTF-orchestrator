...
def _runs_dir() -> str:
    raw = os.getenv("CTF_RUNS_DIR", "").strip()
    return raw or ".runs"
...
MEMORY_TESTED_HYPOTHESES_LIMIT = _env_int("MEMORY_TESTED_HYPOTHESES_LIMIT", 12)
MEMORY_PROMISING_LEADS_LIMIT = _env_int("MEMORY_PROMISING_LEADS_LIMIT", 6)
MEMORY_REJECTED_HYPOTHESES_LIMIT = _env_int("MEMORY_REJECTED_HYPOTHESES_LIMIT", 10)
MEMORY_USEFUL_ARTIFACTS_LIMIT = _env_int("MEMORY_USEFUL_ARTIFACTS_LIMIT", 20)
MEMORY_REACHABLE_TARGETS_LIMIT = _env_int("MEMORY_REACHABLE_TARGETS_LIMIT", 8)
MEMORY_EXPLORATION_BRANCHES_LIMIT = _env_int("MEMORY_EXPLORATION_BRANCHES_LIMIT", 16)
MEMORY_BACKEND_PERFORMANCE_LIMIT = _env_int("MEMORY_BACKEND_PERFORMANCE_LIMIT", 8)
MEMORY_CONFIRMED_FINDINGS_LIMIT = _env_int("MEMORY_CONFIRMED_FINDINGS_LIMIT", 8)
MEMORY_LOW_VALUE_PATHS_LIMIT = _env_int("MEMORY_LOW_VALUE_PATHS_LIMIT", 6)
MEMORY_KEY_COMMANDS_LIMIT = _env_int("MEMORY_KEY_COMMANDS_LIMIT", 8)
MEMORY_INLINE_SCRIPTS_LIMIT = _env_int("MEMORY_INLINE_SCRIPTS_LIMIT", 4)
MEMORY_HANDOFF_FILES_LIMIT = _env_int("MEMORY_HANDOFF_FILES_LIMIT", 10)
RESUME_HISTORY_DEPTH = _env_int("RESUME_HISTORY_DEPTH", 6)
RESUME_KEY_COMMANDS_LIMIT = _env_int("RESUME_KEY_COMMANDS_LIMIT", 4)
RESUME_EVIDENCE_LIMIT = _env_int("RESUME_EVIDENCE_LIMIT", 3)
RESUME_INLINE_SCRIPTS_LIMIT = _env_int("RESUME_INLINE_SCRIPTS_LIMIT", 2)
RESUME_HANDOFF_FILES_LIMIT = _env_int("RESUME_HANDOFF_FILES_LIMIT", 4)
